...
/* harmony import */ var _forgotpass_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./forgotpass-routing.module */ 1615);
    ...
    updatePassword() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            if (this.email.trim().length === 0) {
                yield this.presentToast('Please input your email!');
                return;
            }
            (0,_angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__.sendPasswordResetEmail)(this.auth, this.email)
                .then((res) => {
...
ForgotpassPage.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: ForgotpassPage, selectors: [["app-forgotpass"]], decls: 18, vars: 1, consts: [["slot", "start"], [1, "container", "ion-text-center"], ["src", "assets/3.png"], [1, "center"], ["lines", "full"], ["position", "floating"], ["type", "email", "name", "email", "required", "", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "changepass", 3, "click"]], template: function ForgotpassPage_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngModelChange", function ForgotpassPage_Template_ion_input_ngModelChange_13_listener($event) { return ctx.email = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]()();
